...
// Leads
import Leads from '../views/backend/Main/Leads';
import Leadsedit from '../views/backend/Main/Leadsedit';
import Leadsadd from '../views/backend/Main/Leadsadd';
import Leadsremark from '../views/backend/Main/LeadsRemark.js';
import Leadsschedule from '../views/backend/Main/LeadsSchedule.js';

// Assets
import Assets from '../views/backend/Main/Assets';
import Assetsadd from '../views/backend/Main/Assetsadd';

// Notification
import Notification  from '../views/backend/Main/Notification.js'
...
//Formss
import Formss   from '../views/backend/pages/Formss'
import Formsedit from '../views/backend/pages/Formsedit.js';
import Formsadd from '../views/backend/pages/Formsadd.js';
        ...
        <TransitionGroup>
            ...
            >
                <Switch  location={location}>
                    ...
                    <Route path="/leads-add"        component={Leadsadd}/>
                    <Route path="/leads-edit"        component={Leadsedit}/>
                    <Route path="/leads-schedule"        component={Leadsschedule}/>
                    <Route path="/leads-remark"        component={Leadsremark}/>
                    <Route path="/leads-edit"        component={Leadsedit}/>

                    {/* Assets */}
                    <Route path="/assets"              component={Assets}/>
                    <Route path="/assets-add"              component={Assetsadd}/>

                    {/* Formss */}
                    <Route path="/formss"    component={Formss} />
                    <Route path="/forms-add"     component={Formsadd}/>
                    <Route path="/forms-edit"     component={Formsedit}/>
